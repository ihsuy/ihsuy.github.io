...
`);const Xe=function(){const t=["Hi there!","\u3053\u3093\u306b\u3061\u306f","Hallo!","\u4f60\u597d"],[n,r]=(0,e.useState)(0),[a,i]=(0,e.useState)(!1),[o,l]=(0,e.useState)(!1),[s,u]=(0,e.useState)(!1),[c,d]=(0,e.useState)({x:0,y:0});return(0,e.useEffect)(()=>{let e;return a?e=setInterval(()=>{l(!0),setTimeout(()=>{r(e=>(e+1)%t.length),l(!1)},200)},2200):(r(0),l(!1)),()=>clearInterval(e)},[a,t.length]),(0,Le.jsxs)(Fe,{children:[(0,Le.jsxs)(Be,{children:[(0,Le.jsxs)(Ue,{children:[(0,Le.jsx)($e,{className:o?"changing":"",onMouseEnter:()=>i(!0),onMouseLeave:()=>i(!1),children:t[n]}),(0,Le.jsxs)(He,{children:[(0,Le.jsx)(Ve,{href:"https://www.linkedin.com/in/yushiq/",target:"_blank",rel:"noopener noreferrer",title:"LinkedIn",children:(0,Le.jsx)("svg",{viewBox:"0 0 24 24",children:(0,Le.jsx)("path",{d:"M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"})})}),(0,Le.jsx)(Ve,{href:"https://github.com/ihsuy",target:"_blank",rel:"noopener noreferrer",title:"GitHub",children:(0,Le.jsx)("svg",{viewBox:"0 0 24 24",children:(0,Le.jsx)("path",{d:"M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"})})})]})]}),(0,Le.jsx)(We,{children:"Hi \ud83d\udc4b I'm Yushi Chonan (aka Yushi Qiu), based in Tokyo and working at Anthropic as a member of technical staff. I'm passionate about using engineering to get things done, and what gives me the most energy is seeing whether what I build changes anything real - for a team, a company, or a person trying to do their job. Before Anthropic, I spent five years at Palantir building Japan's commercial business from scratch, working closely with teams across manufacturing, logistics, supply chain, telecom, elderly care, and disaster response - finding where technology could genuinely help, then making it work in practice, which was as much about trust and understanding as it was about code. I joined Anthropic because I was moved by the integrity people hold themselves to, and because I believe the most important leverage point right now is at the model layer - I want to be close to that work while helping bring it to the people and organizations who can use it well and safely. I'm happiest when I'm learning something real and hard, working with low-ego people who push back to protect what they hold firmly true, and building toward something great and sustainable together."}),(0,Le.jsxs)(Qe,{children:[(0,Le.jsx)(Ke,{src:Oe,alt:"Yushi Chonan (formerly Yushi Qiu)",onMouseEnter:()=>{u(!0)},onMouseLeave:()=>{u(!1)},onMouseMove:e=>{d({x:e.clientX,y:e.clientY})}}),(0,Le.jsx)(Ge,{className:s?"visible":"",style:{left:`${c.x}px`,top:`${c.y}px`},children:"Snapped by my friend Akil during a customer visit in Kuala Lumpur-this was at the National Museum of Malaysia, where we took a little detour for some culture"})]})]}),(0,Le.jsx)(Ye,{onClick:()=>window.scrollTo({top:window.innerHeight,behavior:"smooth"}),children:(0,Le.jsx)(qe,{})})]})};n(874),n(514),n(958);const Ze=n.p+"static/media/palantir.ed45f602b201b630ee0b5087ab9b60da.svg",Je=n.p+"static/media/utokyo.dd8bb2daf7f0e633ff41.png";const et=n.p+"static/media/daimler.952f05b5b00719dc1d5613553eaa9540.svg",tt=De.section`
  min-height: 100vh;
...
`,Lt=De.button`
  ...
  animation: ${Ot} 14s ease-in-out infinite;
...
`,An=De.g`
  opacity: 0;
  animation: ${xn} 480ms cubic-bezier(0.32, 0.72, 0, 1) forwards;
...
`,Cn=De.path`
  ...
  opacity: 0;
  animation: ${kn} 600ms cubic-bezier(0.32, 0.72, 0, 1) forwards;
  animation-delay: ${e=>e.delay}ms;
`,En=De.text`
  font-family: inherit;
  font-size: 9.5px;
...
`,$n=["#5BA4E2","#E5765B","#6BA4B8","#B07ED4"],Hn=["Layer 12","Layer 27","Layer 41","Layer 53"],Vn=De.circle`
  transition:
    cx 900ms cubic-bezier(0.32, 0.72, 0, 1),
    cy 900ms cubic-bezier(0.32, 0.72, 0, 1);
  transition-delay: ${e=>e.delay}ms;
`,Wn=()=>Array.from({length:4},()=>Array.from({length:56},()=>It())),Qn=t=>{let{visible:n}=t;const[r,a]=(0,e.useState)(!1),[i,o]=(0,e.useState)(0),[l,s]=(0,e.useState)(!1),u=(0,e.useMemo)(Wn,[i]),c=(0,e.useMemo)(()=>u.map(Mt),[u]);(0,e.useEffect)(()=>{if(!n||l)return;const e=setTimeout(()=>a(!0),900),t=setTimeout(()=>a(!1),3600),r=setTimeout(()=>s(!0),3800);return()=>{clearTimeout(e),clearTimeout(t),clearTimeout(r)}},[n,l]);const d=e=>28+(3.2-e)/6.4*264;return(0,Le.jsxs)(qt,{children:[(0,Le.jsxs)(Xt,{children:[(0,Le.jsx)(Zt,{children:"\u2460 Four weight vectors"}),(0,Le.jsx)(Jt,{active:r,children:r?"Sorted within each vector":"Original order"})]}),(0,Le.jsxs)("div",{style:{position:"relative"},children:[(0,Le.jsxs)(nn,{viewBox:"0 0 880 320",preserveAspectRatio:"xMidYMid meet",children:[(0,Le.jsx)("line",{x1:40,y1:d(0),x2:840,y2:d(0),stroke:"rgba(0,0,0,0.06)",strokeWidth:"1"}),u.map((e,t)=>e.map((e,n)=>{const a=r?c[t][n]:n;return(0,Le.jsx)(Vn,{cx:(i=a,40+i/55*800),cy:d(e),r:"2.75",fill:$n[t],opacity:"0.72",delay:90*t},`${t}-${n}`);var i}))]}),(0,Le.jsx)(rn,{show:r,children:"All four collapse onto one curve"})]}),(0,Le.jsx)(en,{children:Hn.map((e,t)=>(0,Le.jsx)(tn,{color:$n[t],children:e},t))}),(0,Le.jsxs)(an,{children:[(0,Le.jsx)(on,{onClick:()=>a(e=>!e),children:r?"Restore original order":"Sort within each vector"}),(0,Le.jsx)(ln,{onClick:()=>{a(!1),o(e=>e+1)},children:"Draw new sample"})]})]})},Kn=40,Gn=[1,1,1,1,1],Yn=[1.6,-1.6,1.6,-1.6,1.6],qn=62,Xn=238,Zn=e=>42+e/4*236,Jn=qn+176/3,er=qn+352/3,tr=e=>e.map(e=>{const t=Zn(e.row),n=Zn(e.col);return{c1y:t+(n-t)/3,v1:0,c2y:t+2*(n-t)/3,v2:0}}),nr=e=>{const t=e.replace("#","");return{r:parseInt(t.slice(0,2),16),g:parseInt(t.slice(2,4),16),b:parseInt(t.slice(4,6),16)}},rr=(e,t,n)=>{const r=nr(e),a=nr(t);return`rgb(${Math.round(r.r+(a.r-r.r)*n)}, ${Math.round(r.g+(a.g-r.g)*n)}, ${Math.round(r.b+(a.b-r.b)*n)})`},ar=e=>{const t=Math.max(-2,Math.min(2,e))/2;return t<0?rr("#EEE5D2","#3A85C7",-t):rr("#EEE5D2","#CC785C",t)},ir=e=>Math.abs(e)>1?"#ffffff":"#1d1d1f",or=()=>Array.from({length:25},()=>1.2*It()),lr=()=>Array.from({length:25},(e,t)=>({row:Math.floor(t/5),col:t%5})),sr=(e,t)=>{const n=new Array(5).fill(0);return e.forEach((e,r)=>{n[e.col]+=Gn[e.row]*t[r]}),n},ur=(e,t)=>sr(e,t).reduce((e,t,n)=>e+(t-Yn[n])**2,0),cr=e=>48+45*e,dr=e=>50+45*e,fr=De.div`
  display: grid;
...
`,mr=t=>{let{visible:n}=t;const[r,a]=(0,e.useState)(0),[i,o]=(0,e.useState)(!1),[l,s]=(0,e.useState)(!1),u=(0,e.useMemo)(or,[r]),[c,d]=(0,e.useState)(lr),f=(0,e.useRef)(lr().map(e=>({row:e.row,col:e.col}))),p=(0,e.useRef)(lr().map(()=>({row:0,col:0}))),h=(0,e.useRef)(tr(lr())),m=(0,e.useRef)(c),g=(0,e.useRef)(null),y=(0,e.useRef)(0),v=(0,e.useRef)([]),[,b]=(0,e.useReducer)(e=>e+1,0);(0,e.useEffect)(()=>{m.current=c,(()=>{if(null!=g.current)return;y.current=performance.now();const e=t=>{const n=Math.min(.032,(t-y.current)/1e3);y.current=t;const r=m.current,a=f.current,i=p.current,o=h.current;let l=!1;for(let e=0;e<a.length;e++){for(const o of["row","col"]){const t=a[e][o],s=r[e][o],u=i[e][o],c=u+(-90*(t-s)-14*u)*n,d=t+c*n;i[e][o]=c,a[e][o]=d,(Math.abs(d-s)>.0015||Math.abs(c)>.0015)&&(l=!0)}const t=Zn(a[e].row),s=Zn(a[e].col),u=t+(s-t)/3,c=t+2*(s-t)/3,d=o[e],f=-70*(d.c1y-u)-7*d.v1;d.v1+=f*n,d.c1y+=d.v1*n;const p=-70*(d.c2y-c)-7*d.v2;d.v2+=p*n,d.c2y+=d.v2*n,(Math.abs(d.c1y-u)>.05||Math.abs(d.v1)>.05||Math.abs(d.c2y-c)>.05||Math.abs(d.v2)>.05)&&(l=!0)}if(b(),l)g.current=requestAnimationFrame(e);else{for(let e=0;e<a.length;e++){a[e].row=r[e].row,a[e].col=r[e].col,i[e].row=0,i[e].col=0;const t=Zn(r[e].row),n=Zn(r[e].col);o[e].c1y=t+(n-t)/3,o[e].c2y=t+2*(n-t)/3,o[e].v1=0,o[e].v2=0}g.current=null,b()}};g.current=requestAnimationFrame(e)})()},[c]);const w=()=>{v.current.forEach(clearTimeout),v.current=[]},x=e=>{w(),null!=g.current&&(cancelAnimationFrame(g.current),g.current=null),f.current=e.map(e=>({row:e.row,col:e.col})),p.current=e.map(()=>({row:0,col:0})),h.current=tr(e),m.current=e,d(e),b()};(0,e.useEffect)(()=>{x(lr()),o(!1),s(!1)},[r]),(0,e.useEffect)(()=>()=>{v.current.forEach(clearTimeout),null!=g.current&&cancelAnimationFrame(g.current)},[]);const k=ur(c,u),S=sr(c,u),A=Math.min(1,k/14),C=k<.6,E=()=>{if(i)return;w();let e=c.map(e=>({...e})),t=ur(e,u);const n=[];for(let r=0;r<3e4&&n.length<9;r++){const r=Math.floor(25*Math.random()),a=Math.floor(25*Math.random());if(r===a)continue;const i=e.map(e=>({...e})),o=i[r];i[r]=i[a],i[a]=o;const l=ur(i,u);if(l<t-1e-9&&(e=i,t=l,n.push({w1:r,w2:a}),t<.05))break}0!==n.length&&(o(!0),n.forEach((e,t)=>{const r=setTimeout(()=>{d(t=>{const n=t.map(e=>({...e})),r=n[e.w1];return n[e.w1]=n[e.w2],n[e.w2]=r,n}),t===n.length-1&&v.current.push(setTimeout(()=>o(!1),700))},240*(t+1));v.current.push(r)}))};(0,e.useEffect)(()=>{if(!n||l)return;const e=setTimeout(()=>{E(),s(!0)},1400);return()=>clearTimeout(e)},[n,l]);const P=f.current,_=p.current;return(0,Le.jsxs)(qt,{children:[(0,Le.jsxs)(Xt,{children:[(0,Le.jsx)(Zt,{children:"\u2461 Reconnection alone trains the network"}),(0,Le.jsx)(Jt,{active:C,children:i?"Reconnecting\u2026":C?"Trained - output matches target":"Untrained - output \u2260 target"})]}),(0,Le.jsx)(hr,{lossNorm:A}),(0,Le.jsxs)(fr,{children:[(0,Le.jsxs)("div",{children:[(0,Le.jsxs)(nn,{viewBox:"0 0 278 318",preserveAspectRatio:"xMidYMid meet",children:[Array.from({length:5},(e,t)=>(0,Le.jsxs)("text",{x:34,y:dr(t)+20+3,fontSize:"9",fill:"#86868b",textAnchor:"end",fontFamily:"inherit",children:["x",t]},`rl-${t}`)),(0,Le.jsx)("text",{x:158,y:20,fontSize:"9",fill:"#86868b",textAnchor:"middle",fontFamily:"inherit",children:"target output"}),Yn.map((e,t)=>(0,Le.jsx)("circle",{cx:cr(t)+20,cy:35,r:"6",fill:"none",stroke:ar(e),strokeWidth:"1.75",strokeDasharray:"3 3",opacity:"0.75"},`tg-${t}`)),Array.from({length:25},(e,t)=>{const n=Math.floor(t/5),r=t%5;return(0,Le.jsx)("rect",{x:cr(r),y:dr(n),width:Kn,height:Kn,rx:"7",fill:"rgba(0,0,0,0.025)"},`bg-${t}`)}),u.map((e,t)=>{const n=P[t],r=cr(n.col)+20,a=dr(n.row)+20,i=Math.hypot(_[t].row,_[t].col),o=1+Math.min(.13,.05*i);return(0,Le.jsxs)("g",{transform:`translate(${r} ${a}) scale(${o})`,children:[(0,Le.jsx)("rect",{x:-20,y:-20,width:Kn,height:Kn,rx:"7",fill:ar(e),stroke:"rgba(0,0,0,0.08)",strokeWidth:"1"}),(0,Le.jsx)("text",{x:"0",y:"4",fontSize:"10.5",fill:ir(e),textAnchor:"middle",fontFamily:"inherit",style:{pointerEvents:"none",userSelect:"none"},children:e.toFixed(1)})]},t)}),(0,Le.jsx)("text",{x:158,y:286,fontSize:"9",fill:"#86868b",textAnchor:"middle",fontFamily:"inherit",children:"column sum"}),S.map((e,t)=>(0,Le.jsx)("circle",{cx:cr(t)+20,cy:300,r:"8",fill:ar(e),stroke:"rgba(0,0,0,0.12)",strokeWidth:"1"},`os-${t}`))]}),(0,Le.jsx)(pr,{children:"weight matrix"})]}),(0,Le.jsxs)("div",{children:[(0,Le.jsxs)(nn,{viewBox:"0 0 300 318",preserveAspectRatio:"xMidYMid meet",children:[(0,Le.jsx)("text",{x:qn,y:24,fontSize:"9",fill:"#86868b",textAnchor:"middle",fontFamily:"inherit",children:"inputs"}),(0,Le.jsx)("text",{x:Xn,y:24,fontSize:"9",fill:"#86868b",textAnchor:"middle",fontFamily:"inherit",children:"outputs \xb7 target"}),u.map((e,t)=>{const n=P[t],r=h.current[t],a=Zn(n.row),i=Zn(n.col),o=Math.min(3.5,1.4*Math.abs(e)+.5);return(0,Le.jsx)("path",{d:`M 62 ${a} C ${Jn} ${r.c1y} ${er} ${r.c2y} 238 ${i}`,fill:"none",stroke:ar(e),strokeWidth:o,strokeLinecap:"round",opacity:"0.72"},t)}),Array.from({length:5},(e,t)=>(0,Le.jsx)("circle",{cx:qn,cy:Zn(t),r:12,fill:"#2a2a2c"},`in-${t}`)),S.map((e,t)=>(0,Le.jsxs)("g",{children:[(0,Le.jsx)("circle",{cx:Xn,cy:Zn(t),r:16,fill:"none",stroke:ar(Yn[t]),strokeWidth:"1.5",strokeDasharray:"3 3",opacity:"0.55"}),(0,Le.jsx)("circle",{cx:Xn,cy:Zn(t),r:12,fill:ar(e),stroke:"rgba(0,0,0,0.14)",strokeWidth:"1"})]},`on-${t}`))]}),(0,Le.jsx)(pr,{children:"network connections"})]})]}),(0,Le.jsxs)(en,{style:{marginTop:"0.75rem"},children:[(0,Le.jsx)(tn,{color:"#3A85C7",children:"negative weight"}),(0,Le.jsx)(tn,{color:"#CC785C",children:"positive weight"}),(0,Le.jsx)("span",{style:{color:"#86868b"},children:"same values, reconnected - a cell glides to a new slot; its cable end slides to the new neuron"})]}),(0,Le.jsxs)(an,{children:[(0,Le.jsx)(on,{onClick:E,disabled:i,children:i?"Reconnecting\u2026":"Reconnect to train"}),(0,Le.jsx)(ln,{onClick:()=>{i||(w(),d(e=>{const t=e.map(e=>({...e}));for(let n=t.length-1;n>0;n--){const e=Math.floor(Math.random()*(n+1));[t[n],t[e]]=[t[e],t[n]]}return t}))},disabled:i,children:"Random shuffle"}),(0,Le.jsx)(ln,{onClick:()=>x(lr()),disabled:i,children:"Reset"}),(0,Le.jsx)(ln,{onClick:()=>a(e=>e+1),disabled:i,children:"New init"}),(0,Le.jsx)(sn,{children:(0,Le.jsxs)("span",{children:["Loss",(0,Le.jsx)("strong",{children:k.toFixed(2)})]})})]})]})},gr=e=>{let{phase:t}=e;const n=[.6,-.4,.2,-.7,.5],r=[...n].sort((e,t)=>e-t);return(0,Le.jsx)("svg",{viewBox:"0 0 84 36",width:"84",height:"36",children:n.map((e,n)=>{const a=8+17*n,i=18-12*(e+(r[n]-e)*t);return(0,Le.jsx)("circle",{cx:a,cy:i,r:"3",fill:$n[n%$n.length],opacity:"0.85"},n)})})},yr=()=>{const[t,n]=(0,e.useState)(!1),[r,a]=(0,e.useState)(!1),[i,o]=(0,e.useState)(!1),l=(()=>{const[t,n]=(0,e.useState)(0);return(0,e.useEffect)(()=>{let e;const t=performance.now(),r=a=>{const i=(a-t)/1e3%4,o=i<2?i/2:(4-i)/2,l=.5-.5*Math.cos(Math.PI*o);n(l),e=requestAnimationFrame(r)};return e=requestAnimationFrame(r),()=>cancelAnimationFrame(e)},[]),t})(),s=(0,e.useRef)(null),u=()=>{n(!1),setTimeout(()=>a(!1),800)};return(0,Le.jsxs)(Dt,{children:[(0,Le.jsxs)(Lt,{onClick:t?u:()=>{a(!0),requestAnimationFrame(()=>n(!0))},"aria-expanded":t,children:[(0,Le.jsx)(Ft,{children:(0,Le.jsx)(gr,{phase:l})}),(0,Le.jsxs)(Bt,{children:[(0,Le.jsx)(Ut,{children:"Interactive \xb7 NeurIPS 2020"}),(0,Le.jsx)($t,{children:"Train by Reconnect - see the idea in motion"}),(0,Le.jsx)(Ht,{children:"Two short demos - the observation, and how reconnection alone trains a network."})]}),(0,Le.jsx)(Vt,{children:t?"\u2191":"\u2192"})]}),(0,Le.jsx)(Wt,{expanded:t,ref:s,children:r&&(0,Le.jsxs)(Qt,{children:[(0,Le.jsx)(Kt,{children:"\u2460 The discovery"}),(0,Le.jsxs)(Gt,{children:["Same values.",(0,Le.jsx)("span",{children:"Different positions."})]}),(0,Le.jsxs)(Yt,{children:["The information learned by SGD appears to be encoded primarily in the ",(0,Le.jsx)("em",{children:"ordering"})," ","of weights rather than their ",(0,Le.jsx)("em",{children:"values"}),". Sort within each vector and the four distributions collapse onto a single curve."]}),(0,Le.jsx)(Qn,{visible:t}),(0,Le.jsx)(Kt,{style:{marginTop:"2.25rem"},children:"\u2461 The consequence"}),(0,Le.jsxs)(Gt,{children:["Reconnect alone.",(0,Le.jsx)("span",{children:"The network trains."})]}),(0,Le.jsxs)(Yt,{children:["If the information lives in the order, a different ",(0,Le.jsx)("em",{children:"assignment"})," of the same initial values to a network's connections should already be enough to train. Below is a 5\xd75 weight matrix - each cell is one connection. Reconnection moves a cell to a new position. No value is ever changed; the trained matrix is, visibly, a",(0,Le.jsx)("em",{children:" permutation of the random init"}),"."]}),(0,Le.jsx)(mr,{visible:t}),(0,Le.jsxs)(un,{children:[(0,Le.jsx)(cn,{children:"Where it led"}),(0,Le.jsxs)(dn,{children:["This conceptual decoupling - separating ",(0,Le.jsx)("em",{children:"what"})," a weight is from ",(0,Le.jsx)("em",{children:"where"})," ","it sits - contributed to a research direction in fixed-weight physical AI substrates. Downstream work in that direction has demonstrated up to ",(0,Le.jsx)("strong",{children:"238\xd7 energy efficiency gains"})," over conventional FPGA-based inference at matched accuracy."]}),(0,Le.jsx)(fn,{open:i,onClick:()=>o(e=>!e),children:i?"Hide downstream lineage":"View downstream lineage"}),(0,Le.jsx)(pn,{open:i,children:i&&(0,Le.jsx)(Ln,{visible:i})})]}),(0,Le.jsxs)(Fn,{children:["From"," ",(0,Le.jsx)("a",{href:"https://papers.nips.cc/paper/2020/hash/f0682320ccbbb1f1fb1e795de5e5639a-Abstract.html",target:"_blank",rel:"noopener noreferrer",children:"Train-by-Reconnect: Decoupling Locations of Weights from their Values"})," ","(NeurIPS 2020). Plots in \u2460 use independent draws from a standard normal as a stand-in for trained-network weight vectors; the paper shows real layers (ResNet, VGG, MobileNet, NASNet) exhibit the same collapse when sorted. The 5\xd75 network in \u2461 uses a fixed input pattern; ",(0,Le.jsx)("em",{children:"Reconnect to train"})," runs a short random-swap search over edge assignments - no weight value ever changes."]}),(0,Le.jsx)(Bn,{children:(0,Le.jsx)(Un,{onClick:u,children:"Collapse \u2191"})})]})})]})},vr=De.section`
  min-height: 100vh;
...
`,Or=e=>{let{text:t,className:n}=e;const r=(e=>{if(!e)return null;const t=/\[([^\]]+)\]\(([^)]+)\)/g,n=[];let r,a=0;for(;null!==(r=t.exec(e));)r.index>a&&n.push(e.slice(a,r.index)),n.push({type:"link",text:r[1],url:r[2]}),a=r.index+r[0].length;return a<e.length&&n.push(e.slice(a)),n.length>0?n:[e]})(t);return(0,Le.jsx)("span",{className:n,children:r.map((e,t)=>"string"===typeof e?e:"link"===e.type?(0,Le.jsx)(Dr,{href:e.url,target:"_blank",rel:"noopener noreferrer",children:e.text},t):null)})},Lr=De.a`
  font-size: 0.8rem;
  color: #4CAF50;
  text-decoration: none;
  font-weight: 300;
...
`,Fr=()=>{const t=[{degree:"PhD (drop out)",school:"The University of Tokyo",duration:"2020 - 2021",description:"Conducting research in deep learning after completing a mathematics-focused bachelor's degree. My work explored DNN's training dynamics, especially around how weight structures, rather than their numerical values, drives learning in neural networks. I left the program in 2021 to pursue real-world impact in industry, carrying forward the same curiosity and rigor into real-world systems",schoolInitial:"UTokyo",publications:[{title:"Train-by-Reconnect: Decoupling Locations of Weights from their Values",description:"In Proceedings of NeurIPS 2020",link:"https://papers.nips.cc/paper/2020/hash/f0682320ccbbb1f1fb1e795de5e5639a-Abstract.html",image:Nt,demo:"train-by-reconnect",venue:"NeurIPS 2020"}]},{degree:"Master of Science",school:"The University of Tokyo",duration:"2018 - 2020",description:"",schoolInitial:"UTokyo",publications:[{title:"Permute to Train: A New Dimension to Training Deep Neural Networks",description:"Preprint available @ [Arxiv](https://arxiv.org/abs/2003.02570v4)",image:zt,link:"https://github.com/ihsuy/SGPerm"},{title:"Online Autotuning of Parameters of GA-BiCG",description:"Oral Presentation at [ATAT in HPSC](https://sites.google.com/site/atathpsc/previous-conf/2018?authuser=0) (2018)",image:Rt}]},{degree:"Bachelor of Science",school:"University of Illinois Urbana-Champaign",duration:"2012 - 2017",description:"",schoolInitial:"UIUC"}];return(0,Le.jsxs)(vr,{children:[(0,Le.jsx)(br,{children:"Academic Background & Publications"}),(0,Le.jsx)(wr,{children:t.map((t,n)=>(0,Le.jsx)(xr,{children:(0,Le.jsxs)(kr,{children:[(0,Le.jsx)(Sr,{children:t.degree}),(0,Le.jsxs)(Ar,{children:[(0,Le.jsx)(Cr,{children:t.school}),(0,Le.jsx)(Er,{children:(0,Le.jsx)("span",{children:t.duration})})]}),t.description&&(0,Le.jsx)(Pr,{children:t.description}),t.publications&&t.publications.length>0&&(0,Le.jsxs)(_r,{children:[(0,Le.jsx)(jr,{children:"Publications"}),t.publications.map((t,n)=>(0,Le.jsxs)(e.Fragment,{children:[(0,Le.jsxs)(Tr,{children:[(0,Le.jsx)(Nr,{src:t.image,alt:t.title}),(0,Le.jsxs)(zr,{children:[t.venue&&(0,Le.jsx)(Ir,{children:t.venue}),(0,Le.jsx)(Rr,{children:t.title}),t.description&&(0,Le.jsx)(Mr,{children:(0,Le.jsx)(Or,{text:t.description})}),t.link&&(0,Le.jsx)(Lr,{href:t.link,target:"_blank",rel:"noopener noreferrer",children:"View Paper \u2192"})]})]}),"train-by-reconnect"===t.demo&&(0,Le.jsx)(yr,{})]},n))]})]})},n))})]})},Br=De.div`
  width: 100%;
  min-height: 100vh;
  scroll-behavior: smooth;
`,Ur=()=>(0,Le.jsxs)(Br,{children:[(0,Le.jsx)(Xe,{}),(0,Le.jsx)(Tt,{}),(0,Le.jsx)(Fr,{})]}),$r=(function(t){for(var n=arguments.length,r=new Array(n>1?n-1:0),a=1;a<n;a++)r[a-1]=arguments[a];var i=ve.apply(void 0,[t].concat(r)),o="sc-global-"+Se(JSON.stringify(i)),l=new Ie(i,o);function s(t){var n=oe(),r=le(),a=(0,e.useContext)(je),i=(0,e.useRef)(n.allocateGSInstance(o)).current;return n.server&&u(i,t,n,a,r),(0,e.useLayoutEffect)(function(){if(!n.server)return u(i,t,n,a,r),function(){return l.removeStyles(i,n)}},[i,t,n,a,r]),null}function u(e,t,n,r,a){if(l.isStatic)l.renderStyles(e,A,n,a);else{var i=p({},t,{theme:be(t,r,s.defaultProps)});l.renderStyles(e,i,n,a)}}return e.memo(s)})`
...
`,Hr={colors:{primary:"#667eea",secondary:"#764ba2",background:"#ffffff",text:"#2c3e50",lightGray:"#f8f9fa",darkGray:"#6c757d"},fonts:{primary:"'Inter', 'Segoe UI', 'Roboto', sans-serif",heading:"'Inter', 'Segoe UI', 'Roboto', sans-serif"},breakpoints:{mobile:"768px",tablet:"1024px",desktop:"1200px"}};const Vr=function(){return(0,Le.jsx)(Te,{theme:Hr,children:(0,Le.jsxs)(Le.Fragment,{children:[(0,Le.jsx)($r,{}),(0,Le.jsx)("div",{className:"App",children:(0,Le.jsx)(Ur,{})}),(0,Le.jsx)("div",{className:"pos-f-t p-2 margin",children:(0,Le.jsx)("span",{className:"copyright",children:"\xa9\ufe0f Yushi Chonan. All rights reserved."})})]})})},Wr=e=>{e&&e instanceof Function&&console.log("Performance monitoring disabled")},Qr=document.getElementById("root");(0,t.H)(Qr).render((0,Le.jsx)(e.StrictMode,{children:(0,Le.jsx)(Vr,{})})),Wr()})()})();
//# sourceMappingURL=main.d878dcb6.js.map